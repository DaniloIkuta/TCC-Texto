...
% ---
\titulo{Extração de Componentes de Arquivos de Música}
...
Para Fourier(\citeonline{Grattan-Guiness1972}), qualquer sinal periódico, independente da complexidade, pode ser representado como uma somatória de diversas ondas simples(em especial ondas senoidais), variando em frequência, amplitude e fase. Para a análise de sinais digitais de áudio, a STFT(shourtt-time Fourier transform) é utilizada.
...
Proposto por \citeonline{Dressler2006} e utilizado em \citeonline{HsuJ10}, tem como foco o uso de múltiplas resoluções dependendo da faixa de resolução analisada.%CONTINUAR?

%%%%%%%%%%Pré-processamento%%%%%%%%%%
\section{Pré-processamento}
\subsection{Somatória Sub-harmônica}
O método de somatória sub-harmônica, proposto por \citeonline{Hermes1988} e implementado em \citeonline{CaoLLY2007} e \citeonline{HsuCJL2009} representa cada quadro com as estruturas harmônicas realçadas, em especial as provenientes de vocais. O algoritmo é dado por:
\begin{equation}
...
\citeonline{HsuCJL2009}

\subsection{NMF(Fatorização de Matriz Não-negativa)}
\citeonline{RafiiGSM2013}

%%%%%%%%%%Obtenção de Informações do Espectrograma%%%%%%%%%%
...
%Medidas de Desempenho e Formato dos Testes, Resultados dos testes e possíveis melhorias no capítulo de resultados!
