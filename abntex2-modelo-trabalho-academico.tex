...
\usepackage{mathtools}          % Ams/fórmulas matemáticas
% ---
...
- Estimativa de tendência de tom/F0 \citeonline{HsuJ10, CaoLLY2007, JooPJY2011}

\subsection{Somatória Sub-harmônica Normalizada}
Uma forma alternativa e complementar ao rastreamento harmônico é o método de somatória sub-harmônica, proposto por \citeonline{Hermes1988} e implementado em \citeonline{CaoLLY2007} e \citeonline{HsuCJL2009} por representar cada quadro com as estruturas harmônicas realçadas, em especial as provenientes de vocais. O algoritmo é dado por:
\begin{equation}
...
%falar da parte normalizada?

\subsection{Rastreamento Harmônico}
- Rastreamento harmônico \citeonline{CaoLLY2007}

- Remoção parcial de instrumentos \citeonline{HsuJ10}

- Cálculo dos ESIs \citeonline{HsuJ10, HsuCJL2009}

- Extração do contorno/estrutura mais provável \citeonline{HsuJ10, CaoLLY2007, JooPJY2011}

- Estrutura harmônica estável \citeonline{CaoLLY2007}

- Matrizes de similaridade \citeonline{RafiiP2012, RafiiGSM2013}

- Modelo de repetição(acompanhamento) \citeonline{RafiiP2012, RafiiGSM2013}

- Modelos Ocultos de Markov(HMM) \citeonline{HsuCJL2009}

- Modelo de voz \citeonline{RafiiGSM2013}
    - Divergência de Kullback-Leibler \citeonline{RafiiGSM2013}

- Máscara tempo-frequência \citeonline{RafiiP2012, RafiiGSM2013, DriedgerMD2014}

- Fatorização de matriz não-negativa(NMF) \citeonline{RafiiGSM2013}

- Filtros de Wiener \citeonline{RafiiGSM2013}

- Mel-Frequency Cepstral Coefficients(MFCC) \citeonline{HsuCJL2009}

- Suavização de contorno \citeonline{JooPJY2011}

\section{Separação de Elementos Harmônicos e Percussivos}

- Filtros de mediana \citeonline{DriedgerMD2014}
